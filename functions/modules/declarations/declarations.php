...
function init_scripts_styles()
{
    ...
    wp_enqueue_script('_global.js', get_stylesheet_directory_uri().'/dist/scripts/global.js', [
        'jquery',
        'martfury',
    ...
    wp_enqueue_style('lineAwesome', get_stylesheet_directory_uri().'/resources/assets/library/line-awesome/css/line-awesome.min.css', [], rand(), 'all');

    wp_enqueue_style('fontAwesome', get_stylesheet_directory_uri().'/resources/assets/library/font-awesome/css/all.min.css', [], rand(), 'all');

    wp_enqueue_style('animate.css', get_stylesheet_directory_uri().'/resources/assets/library/animate/animate.min.css', [], rand(), 'all');
}
