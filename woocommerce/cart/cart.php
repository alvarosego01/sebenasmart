                ...
                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                    ...
                    <td class="product-remove">
						...
						echo apply_filters(
							...
							'<a href="%s" class="mf-remove hiperRed" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="las la-times"></i></a>',
                        ...
                        <div class="product-content-detail">
							...
							<div class="productControls">
								...
								<!-- <div class="product-remove">
									...
									echo apply_filters(
									'woocommerce_cart_item_remove_link', sprintf(
									'<a href="%s" class="mf-remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="lar la-trash-alt"></i></a>',
									esc_url( wc_get_cart_remove_url( $cart_item_key ) ),
									esc_html__( 'Remove this item', 'martfury' ),
									esc_attr( $product_id ),
									esc_attr( $_product->get_sku() )
