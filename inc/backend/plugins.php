...
function martfury_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'             => esc_url( 'http://demo2.drfuri.com/plugins/martfury-addons.zip?version=2.4.7' ),
			'required'           => true,
			'force_activation'   => false,
			'force_deactivation' => false,
			'version'            => '2.4.7',
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => esc_url( 'http://demo2.drfuri.com/plugins/revslider.zip?version=6.5.21' ),
			'required'           => false,
			'force_activation'   => false,
			'force_deactivation' => false,
		),
	...
	if ( ! defined( 'ELEMENTOR_VERSION' ) && ! defined( 'WPB_VC_VERSION' ) ) {
		$plugins[] = array(
			...
			'slug'               => 'js_composer',
			'source'             => esc_url( 'http://demo2.drfuri.com/plugins/js_composer.zip?version=6.9.0' ),
			'required'           => false,
			'force_activation'   => false,
			'force_deactivation' => false,
		);
