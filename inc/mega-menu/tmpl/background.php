...
<div id="tamm-panel-background" class="tamm-panel-background tamm-panel">
    ...
    <p class="background-text-color">
        <label><?php esc_html_e( 'Text Color', 'martfury' ) ?></label><br>
        <input type="text" class="background-color-picker"
               name="{{ taMegaMenu.getFieldName( 'background.textcolor', itemId ) }}"
               value="{{ data.megaData.background.textcolor }}">
    </p>
</div>